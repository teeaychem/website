! function(n) {
  ...
  var i = function(i, o) {
      ...
      return this.repeat = function() {
        ...
        var n = s[0].tagName;
        return s[0].id && (n += "#" + s[0].id), s[0].className && (n += "." + s[0].className), n
      }, this.css = function() {
        var n = this.selector(),
          i = "",
          o = "",
          a = "";
        null !== t.color && (i += "color: " + t.color + ";", o += "color: " + t.color + "; opacity: 0.3;"), null !== t.glow && (a += "text-shadow: " + t.glow.toString() + ";", i += a);
        var l = "";
        ...
        var i, o, a = r.length,
          ...
          e = t.off,
          s = t.blink;
        return e = Math.min(e, a), e = Math.max(0, e), o = l.splice(0, e), n.each(o, function(n, i) {
          c.off(r.eq(i))
        }), s = 0 === s ? a : s, s = Math.min(s, a - e), s = Math.max(0, s), i = l.splice(0, s)
      }, this.randomArray = function(n) {
        var i, o, t, a = [];
        for (i = 0; n > i; ++i) a[i] = i;
        for (i = 0; n > i; ++i) o = parseInt(Math.random() * n, 10), t = a[o], a[o] = a[i], a[i] = t;
        return a
      }, this.loop = function() {
        if (a && 0 !== e.length) {
          var n, i;
          n = e[c.rand(0, e.length - 1)], i = r.eq(n), i[0].blinking || c.blink(i), l = setTimeout(function() {
            c.loop()
      ...
      }, c.repeat() ? !0 : (t = o, a = !1, l = 0, s.html(c.buildHTML()), r = s.find("span.novacancy"), e = c.arrayMake(), c.bindEvent(), c.writeCSS(), void(t.autoOn && c.blinkOn()))
    },
    o = function(i) {
      var o = n.extend({
